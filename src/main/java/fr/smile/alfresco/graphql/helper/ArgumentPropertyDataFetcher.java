 ...
 */
@PublicApi
public class ArgumentPropertyDataFetcher<T> implements DataFetcher<T>, TrivialDataFetcher<T> {
     ...
     */
    public ArgumentPropertyDataFetcher(String propertyName) {
        this.propertyName = Assert.assertNotNull(propertyName);
        this.function = null;
    }

    @SuppressWarnings("unchecked")
    private <O> ArgumentPropertyDataFetcher(Function<O, T> function) {
     ...
     */
    public static <T> ArgumentPropertyDataFetcher<T> fetching(String propertyName) {
        return new ArgumentPropertyDataFetcher<>(propertyName);
    }
     ...
     * @return a new PropertyDataFetcher using the provided function as its source of values
     */
    public static <T, O> ArgumentPropertyDataFetcher<T> fetching(Function<O, T> function) {
        return new ArgumentPropertyDataFetcher<>(function);
    }
    ...
    public T get(DataFetchingEnvironment environment) {
        ...
        return (T) ArgumentPropertyDataFetcherHelper.getPropertyValue(propertyName, source, environment.getFieldType(), environment);
    }
    ...
    public static void clearReflectionCache() {
    	ArgumentPropertyDataFetcherHelper.clearReflectionCache();
    }
    ...
    public static boolean setUseNegativeCache(boolean flag) {
        return ArgumentPropertyDataFetcherHelper.setUseNegativeCache(flag);
    }
}
