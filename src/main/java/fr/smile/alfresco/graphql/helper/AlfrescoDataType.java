...
public enum AlfrescoDataType {
	...
	LONG (DataTypeDefinition.LONG, 			ScalarType.Int, ScalarType.Int, o -> ((Number) o).intValue()),
	FLOAT (DataTypeDefinition.FLOAT, 		ScalarType.Float, ScalarType.Float),
	DOUBLE (DataTypeDefinition.DOUBLE, 		ScalarType.Float, ScalarType.Float, o -> ((Number) o).floatValue()),
